    ...
    if (result.isConfirmed) {
      ...
      try {
        ...
        const memberData = {
          ...
          total_bill: parseFloat(totalPrice),
          invoice: res?.data?.insertedId,
        };

        if (totalDiscount && totalPrice) {
          const response = await patchApiRequest(
            `/api/v2/member/update/${member?.mobile}`,
            memberData
          );
          setIsOpen(false);
  ...
  return (
    <div>
      ...
      <KitchenModal
        ...
        isKitchenModalOpen={isKitchenModalOpen}
        setIsKitchenModalOpen={setIsKitchenModalOpen}
        filteredTableWiseCart={filteredTableWiseCart}
        kitchenTotalPrice={kitchenTotalPrice}
        handleKitchenDecrease={handleKitchenDecrease}
        handleKitchenIncrease={handleKitchenIncrease}
      />
